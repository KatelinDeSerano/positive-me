...
import { setEmojiValue2 } from "../actions/positive.js";
...
export class EmojiScale2 extends React.Component {

    emojiClick(value) {
        this.props.dispatch(setEmojiValue2(value));
        console.log(this.props.value);
    }
    render() {
        return (
            <div className="emojiScale2">
...
const mapStateToProps = state => ({
    value: state.positiveReducer.emojiValue2
})

export default connect(mapStateToProps)(EmojiScale2);